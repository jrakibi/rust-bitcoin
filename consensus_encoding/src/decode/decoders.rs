...
/// On a 16-bit machine however one cannot represent numbers that big.
///
/// # Errors
///
...
mod tests {
    ...
    check_decode_one_byte_at_a_time! {
        CompactSizeDecoder
        decode_compact_size_0x10, 0x10, [0x10u8];
        decode_compact_size_0xFC, 0xFC, [0xFCu8];
        decode_compact_size_0xFD, 0xFD, [0xFDu8, 0xFD, 0];
        decode_compact_size_0xFFF, 0xFFF, [0xFDu8, 0xFF, 0xF];
        decode_compact_size_0x0F0F_0F0F, 0x0F0F_0F0F, [0xFEu8, 0xF, 0xF, 0xF, 0xF];
        decode_compact_size_0xF0F0_F0F0_F0E0, 0xF0F0_F0F0_F0E0, [0xFFu8, 0xE0, 0xF0, 0xF0, 0xF0, 0xF0, 0xF0, 0, 0];
    }
